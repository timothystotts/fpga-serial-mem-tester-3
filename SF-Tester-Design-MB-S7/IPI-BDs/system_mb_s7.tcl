...
digilentinc.com:IP:PmodSF3:1.0\
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net PmodSF3_0_Pmod_out [get_bd_intf_ports jb] [get_bd_intf_pins PmodSF3_0/Pmod_out]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins PWM_0/PWM_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins PWM_1/PWM_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins PmodSF3_0/AXI_LITE] [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI]
  ...
  connect_bd_net -net PmodSF3_0_QSPI_INTERRUPT [get_bd_pins PmodSF3_0/QSPI_INTERRUPT] [get_bd_pins microblaze_0_xlconcat/In4]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins PmodCLS_0/ext_spi_clk] [get_bd_pins PmodSF3_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out1]
  ...
  assign_bd_address -offset 0x00010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodCLS_0/AXI_LITE_SPI/Reg0] -force
  assign_bd_address -offset 0x00020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodSF3_0/AXI_LITE/Reg0] -force
