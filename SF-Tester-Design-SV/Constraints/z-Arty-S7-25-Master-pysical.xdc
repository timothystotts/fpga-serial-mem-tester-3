...
## Based on Digilent's XDC for the Arty S7-25
##    commit c1e8e6e97cd49b9c6e6c46b0e64ee36b422db90d
##    date 2022-06-01
...
## Buttons
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { ei_bt0 }]; #IO_L18N_T2_A23_15 Sch=btn[0]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { ei_bt1 }]; #IO_L19P_T3_A22_15 Sch=btn[1]
set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { ei_bt2 }]; #IO_L19N_T3_A21_VREF_15 Sch=btn[2]
set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33 } [get_ports { ei_bt3 }]; #IO_L20P_T3_A20_15 Sch=btn[3]

## Pmod Header JA
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { eo_pmod_cls_csn }]; #IO_L4P_T0_D04_14 Sch=ja_p[1]
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { eo_pmod_cls_dq0 }]; #IO_L4N_T0_D05_14 Sch=ja_n[1]
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { ei_pmod_cls_dq1 }]; #IO_L5P_T0_D06_14 Sch=ja_p[2]
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { eo_pmod_cls_sck }]; #IO_L5N_T0_D07_14 Sch=ja_n[2]
...
## Pmod Header JB
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { eo_pmod_sf3_csn }]; #IO_L9P_T1_DQS_14 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { eio_pmod_sf3_copi_dq0 }]; #IO_L9N_T1_DQS_D13_14 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { eio_pmod_sf3_cipo_dq1 }]; #IO_L10P_T1_D14_14 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { eo_pmod_sf3_sck }]; #IO_L10N_T1_D15_14 Sch=jb_n[2]
...
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { eio_pmod_sf3_wrpn_dq2 }]; #IO_L12P_T1_MRCC_14 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { eio_pmod_sf3_hldn_dq3 }]; #IO_L12N_T1_MRCC_14 Sch=jb_n[4]
